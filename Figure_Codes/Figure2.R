...
gene_transcription_error$log  <- gene_transcription_error$Error.rate * 10^6
gene_translation_error$type <- "Mistranslation"
gene_translation_error$log  <- gene_translation_error$Error_Rate * 10^6
...
pergene_TR$log <- pergene_TR$err1* 10^6
pergene_TL$log <- pergene_TL$err2* 10^6
